        ...
        <Head title="Dashboard" />
            <div className="py-12 md:px-0 px-3">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    {auth.user.type === 'employer' && (
                        <ExistingApartmentsEmployer apartment={apartment} sendMessage={sendMessage} employees={employees} auth={auth} payments={payments} approvals={approvals} />
                    )}
