...
const ForumAddForm = ({ forum, cohort, close }) => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Forum:', data.forum_id)
  ...
  return (
    ...
    { forum === null && (
      <div>
        <InputLabel htmlFor="title" value="Forum Title" />
        <TextInput
            id="title"
            type="text"
            name="title"
      ...
      <div className='mt-3'>
        <InputLabel htmlFor="description" value="Forum Description" />
